            ...
            <div class="setting">
                ...
                <div class="fix">
                    <form action="" @submit.prevent="submitHandler">
                        <div class="fix__name" >
                            <input type="text" v-for="c of categories" v-model="c.name">
                    ...
                    <div class="fix__name" >
                        <input type="email" v-for="c of categories" v-model="c.email">
                        <button class="btn__fix" >Изменить Email</button>
                    </div>

                    <div class="fix__name" >
                        <input type="password" v-for="c of categories" v-model="c.password">
...
<script>
    export default {
        ...
        methods: {
            async submitHandler() {
                    const qq = {name: this.name}
                    await this.$store.dispatch('updateCategory', qq)
                    alert('111111111')
